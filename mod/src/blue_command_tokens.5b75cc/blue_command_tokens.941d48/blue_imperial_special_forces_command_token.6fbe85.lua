unitName = 'imperialRoyalGuards'
commandType = 'imperialSpecialForces'
colorSide = 'blue'
-- Model Token
...
function spawnRangeRuler()
    ...
    longMesh = {}
    longMesh[1] = "http://cloud-3.steamusercontent.com/ugc/963116666702885577/6C93696005D62FDD38A344398E06D9AD8753141C/"
    longMesh[2] = "http://cloud-3.steamusercontent.com/ugc/963116666702885670/E6A15521D46FD2CE19CE547612DC2050DC916603/"
    longMesh[3] = "http://cloud-3.steamusercontent.com/ugc/963116666702885880/4AD760438DD5333AD61144E3256533ACC85E08E4/"
    longMesh[4] = "http://cloud-3.steamusercontent.com/ugc/963116666702885997/CFB2183925F6DF41E80A0B2BBB59EB6908DFB103/"
    for i = 1, 4, 1 do
    ...
    if unitData.fixedArc then
        if unitData.baseSize != "long" then
            ...
            frontArc.setCustomObject({
                type = 0,
                mesh = "http://cloud-3.steamusercontent.com/ugc/867365941869577818/BBC5E1730F64EBC971AA582ABF23E3E00246795D/",
                collider = "http://cloud-3.steamusercontent.com/ugc/785234780862865411/C2B5E8CA63651BE485909340212736C0A68C2754/",
                material = 1,
            })
