position = {x = 41.8302764892578, y = 0.948201715946198, z = 1.35741770267487}
rotation = {x = -7.91631173342466E-05, y = 90.0101089477539, z = 3.88770149584161E-06}

scripted = true
colorSide = 'blue'
miniName = 'Mark II Medium Blaster Trooper'
miniGUIDs = {}
miniGUIDs[1] = '6f32b2'
cardGUID = '26ee6e'
unitName = 'markIIMediumBlasterTrooper'
unitID = 1
-- Model mini
function onLoad()
