position = {x = 8.1599235534668, y = 1.23962450027466, z = -12.5223531723022}
rotation = {x = 359.940338134766, y = 179.999618530273, z = 0.169944792985916}

scripted = true
colorSide = 'red'
miniName = 'Darth Vader'
miniGUIDs = {}
miniGUIDs[1] = 'b9f54c'
cardGUID = 'f338d2'
unitName = 'darthVader'
